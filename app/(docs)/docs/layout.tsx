...
import { DocsSidebar } from "@/modules/docs/components/sidebar"
import { DocsSearch } from "@/modules/docs/components/search"
        ...
        <div className="container flex h-14 items-center">
          <div className="mr-4 hidden md:flex">
            ...
            <nav className="flex items-center space-x-6 text-sm font-medium">
              ...
              <a href="/dashboard" className="transition-colors hover:text-foreground/80 text-muted-foreground">
                Dashboard
              </a>
              <a
