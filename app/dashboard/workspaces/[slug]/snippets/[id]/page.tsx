      ...
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="sm" asChild>
            <Link href={`/dashboard/workspaces/${params.slug}/snippets`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <SnippetActions snippet={snippet} workspaceSlug={params.slug} />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:justify-between text-muted-foreground">
          ...
          {snippet.creator && (
            <p>
              Created by {snippet.creator.firstName} {snippet.creator.lastName}
            </p>
          )}
        </div>
        ...
        <Tabs defaultValue={activeTab} className="w-full">
          ...
          <TabsContent value="history" className="mt-6">
            <SnippetVersionHistory snippetId={snippet.id} language={snippet.language} />
          </TabsContent>
        </Tabs>
