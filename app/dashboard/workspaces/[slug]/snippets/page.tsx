...
import { FolderArchiveIcon as ArchiveBox, BookmarkIcon, Pin, Star } from "lucide-react"
...
export default async function SnippetsPage({ params, searchParams }: SnippetsPageProps) {
  ...
  const sortBy = (searchParams.sort || "position") as "title" | "createdAt" | "updatedAt" | "position"
    ...
    <div className="flex flex-col space-y-6">
      ...
      <Tabs defaultValue={view} className="w-full">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="pinned" asChild>
            <a href={`?view=pinned&pinned=true`} className="flex items-center gap-1">
              <Pin className="h-3.5 w-3.5" />
              <span>Pinned</span>
            </a>
          </TabsTrigger>
          <TabsTrigger value="favorites" asChild>
            <a href={`?view=favorites&favorite=true`} className="flex items-center gap-1">
              <Star className="h-3.5 w-3.5" />
              <span>Favorites</span>
            </a>
          </TabsTrigger>
          <TabsTrigger value="public" asChild>
            <a href={`?view=public&public=true`} className="flex items-center gap-1">
              <BookmarkIcon className="h-3.5 w-3.5" />
              <span>Public</span>
            </a>
          </TabsTrigger>
          <TabsTrigger value="archived" asChild>
            <a href={`?view=archived&archived=true`} className="flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <aside className="md:col-span-1">
            <Suspense fallback={<div className="h-[400px] w-full animate-pulse bg-muted rounded-md"></div>}>
              <SnippetsFilters
            ...
            <div className="mt-6">
              <Suspense fallback={<div className="h-[200px] w-full animate-pulse bg-muted rounded-md"></div>}>
