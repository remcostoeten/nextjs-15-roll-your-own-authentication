...
import { Copy, ChevronRight, MoreHorizontal, Eye, Pencil, Trash } from 'lucide-react'
...
export function JSONViewer({
    ...
    const highlightLine = (line: string) => {
        ...
        const patterns = [
            ...
            { pattern: /(".*?")(: )?/g, className: 'text-orange-400 dark:text-orange-300' },
            // Numbers
            { pattern: /\b(\d+\.?\d*)\b/g, className: 'text-purple-500 dark:text-purple-300' },
            // Boolean values
            { pattern: /\b(true|false)\b/g, className: 'text-blue-500 dark:text-blue-300' },
            // Null values
            { pattern: /\b(null)\b/g, className: 'text-gray-500 dark:text-gray-400' },
            // Punctuation
