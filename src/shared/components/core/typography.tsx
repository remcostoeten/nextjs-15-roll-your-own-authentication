...
const headingVariants = cva("text-title-light tracking-tight", {
    variants: {
        ...
        variant: {
            ...
            muted: "text-button",
            gradient: "text-transparent bg-clip-text bg-gradient-to-r from-[#F5F4F4] to-[#4E4B47]",
        },
        align: {
            left: "text-left",
            center: "text-center",
...
const Text = React.forwardRef<HTMLParagraphElement, TextProps>(
    ({
        ...
        return (
            <Component
                ref={ref}
                className={cn(textVariants({ variant, size, weight, align, display, className }))}
                {...props}
            >
                {content}
            </Component>
...
const Heading = React.forwardRef<HTMLHeadingElement, HeadingProps>(
    ({
        ...
        return (
            <HeadingTag
                ref={ref}
                className={cn(headingVariants({ level, variant, align, hasMargin, pageTitle, className }))}
                {...props}
            >
                {content}
            </HeadingTag>
...
const Flex = React.forwardRef<HTMLDivElement, FlexProps>(
    ({
        ...
        return (
            <Component
                ref={ref}
                className={cn(flexVariants({ direction, items, justify, wrap, gap, className }))}
                {...props}
            >
                {children}
            </Component>
