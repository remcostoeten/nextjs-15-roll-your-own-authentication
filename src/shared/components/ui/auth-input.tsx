            ...
            <div className="mb-5">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        style={{ 
                            borderColor: error ? authTheme.colors.error : authTheme.colors.border,
                ...
                {error && (
                    <p className="mt-1.5 text-xs text-red-500" style={{ color: authTheme.colors.error }}>
                        {error}
                    </p>
                )}

                {helper && !error && (
                    <p className="mt-1.5 text-xs text-gray-500" style={{ color: authTheme.colors.textMuted }}>
                        {helper}
                    </p>
                )}
            </div>
