		...
		<div className="relative pb-20">
			...
			<section className="relative pt-16 pb-20 text-center">
				...
				>
					...
					>
						Explore our design system components, typography,
						colors, and layout guidelines for building consistent
						user interfaces.
					</Text>
				</motion.div>
			</section>
								...
								<div className="border border-button-border rounded-lg p-6 bg-background-lighter">
									...
									>
										...
										>
											...
											<Text variant="muted">
												Used for card titles and smaller
												sections
											</Text>
											<code className="mt-2 text-xs bg-background px-2 py-1 rounded text-button">
												{
								...
								<div className="border border-button-border rounded-lg p-6 bg-background-lighter">
									...
									>
										...
										>
											...
											<Text variant="muted">
												Used for highlighting important
												information
											</Text>
											<code className="mt-2 text-xs bg-background px-2 py-1 rounded text-button">
												{
										...
										>
											...
											<Text variant="muted">
												Used for labels and small text
											</Text>
											<code className="mt-2 text-xs bg-background px-2 py-1 rounded text-button">
												{
								...
								<div className="border border-button-border rounded-lg p-6 bg-background-lighter">
									...
									>
										...
										>
											...
											<Text variant="muted">
												Headings with icons before the
												text
											</Text>
											<code className="mt-2 text-xs bg-background px-2 py-1 rounded text-button">
												{
								...
								<div className="border border-button-border rounded-lg p-6 bg-background-lighter">
									...
									>
										...
										>
											...
											>
												<div className="h-16 w-16 bg-button flex items-center justify-center border border-button-border rounded">
													Item 1
												</div>
												<div className="h-16 w-16 bg-button flex items-center justify-center border border-button-border rounded">
													Item 2
										...
										>
											...
											<Flex
												...
												className="bg-background p-4 rounded border border-button-border"
											>
												<div className="h-12 bg-button flex items-center justify-center border border-button-border rounded">
													Item 1
												</div>
												<div className="h-12 bg-button flex items-center justify-center border border-button-border rounded">
													Item 2
								...
								<div className="border border-button-border rounded-lg p-6 bg-background-lighter">
									...
									<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
										...
										<div className="bg-background-lighter border border-button-border rounded-lg p-4">
											...
											<Text variant="muted">
												A simple card without an image
