...
function ProfilePage() {
  ...
  const [loadingState, setLoadingState] = useState<'loading' | 'authenticated' | 'unauthenticated'>('authenticated');
  ...
  if (auth.status === 'unauthenticated') {
    return <div>Please <Link href="/login">log in</Link> to view your profile.</div>;
  }
          ...
          <div className="p-6">
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-6 flex justify-end">
                <UpdateButton onClick={() => handleSubmit(new Event('submit') as unknown as React.FormEvent<HTMLFormElement>)} />
              </div>
            </form>
