                ...
                >
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            className={`w-full rounded-md border bg-[#111111] px-3 py-2 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#2E71E5] ${errors.email
                                ? 'border-red-500'
                                : 'border-gray-700'
                                }`}
                            required
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full rounded-md border bg-[#111111] px-3 py-2 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#2E71E5] ${errors.password
                                ? 'border-red-500'
                                : 'border-gray-700'
                                }`}
                            required
