		...
		<HoverCard>
			<HoverCardTrigger asChild>
				<div className="flex items-center gap-2 cursor-pointer">
					...
					<span className="text-sm">{commit.commit.message.split('\n')[0]}</span>
				</div>
			</HoverCardTrigger>
			<HoverCardContent className="w-80">
				<div className="space-y-2">
					...
					<div className="text-xs text-muted-foreground">
						<p className="font-medium text-foreground line-clamp-2">{commit.commit.message}</p>
						<p className="mt-1 flex items-center gap-1">
							by <span className="font-medium">{commit.author?.login || commit.commit.author?.name || 'Unknown'}</span>
						</p>
			...
			<div className="mx-auto max-w-7xl grid border">
						...
						<div aria-hidden className="flex flex-col gap-8">
							<div>
								...
								<div className="AAAAA bg-background mt-1.5 w-3/5 border p-3 text-xs">
									<TextAnimate className="text-foreground">
							...
							<div>
								<div className="AAAAA mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">
				...
				<div className="border-t relative">
					<div className="absolute z-10 max-w-lg px-6 pr-12 pt-6 md:px-12 md:pt-12">
						...
						{commits.length > 0 && <CommitPopover commit={commits[0]} />}
					</div>
					<MonitoringChart />
				</div>
			</div>
