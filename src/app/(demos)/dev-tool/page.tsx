            ...
            <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                    <Card>
                        ...
                        <CardContent className="flex flex-col items-center gap-4">
                            <p className="text-xl">Current status: {isAuthenticated ? "Authenticated" : "Not Authenticated"}</p>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Use the developer tools to view and manage browser storage</CardDescription>
                        </CardHeader>
                ...
                <div className="mt-8 text-center max-w-md">
                    <p className="text-muted-foreground">
                        The developer tools widget can be dragged anywhere on the screen. Its position will be remembered between
                        page refreshes. Click the gear icon to open the tools panel.
                    </p>
                </div>
            </div>
