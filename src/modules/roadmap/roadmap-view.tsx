        ...
        return (
            <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-zinc-400 mb-12">Our development plans for improving Roll Your Own Auth.</p>
                ...
                <div className="space-y-16">
                    {quarters.length === 0 ? (
                        <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-6 text-center">
                            <p className="text-zinc-400">No roadmap items available yet.</p>
                        </div>
                    ) : (
                            ...
                            <div key={quarter.name}>
                                ...
                                <div className="grid gap-6">
                                    {quarter.items.map(item => (
                                        <div key={item.id} className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-6">
                                            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex items-center gap-1 px-2 py-1 rounded ${votedItems[item.id]
