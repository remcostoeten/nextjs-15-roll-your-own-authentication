                    ...
                    return (
                      <button
                        ...
                        className={`flex w-full items-center gap-2 rounded-md px-2 py-1 text-left text-sm transition-colors ${
                          isActive ? "bg-[#4e9815]/20 text-[#4e9815]" : "text-[#8C877D] hover:bg-[#1E1E1E]"
                        }`}
                        onClick={() => toggleFilter(category as FilterCategory, option.value, option.label)}
                      >
                        <div className={`h-3 w-3 rounded-full ${isActive ? "bg-[#4e9815]" : "bg-[#1E1E1E]"}`} />
