          ...
          >
            ...
            <div className="overflow-y-auto max-h-[90vh] custom-scrollbar">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setFormData({ ...formData, priority: e.target.value as RoadmapPriority })}
                          className="w-full px-3 py-2 bg-[#1E1E1E] border border-[#2D2D2D] rounded-md text-[#F2F0ED] focus:outline-none focus:ring-1 focus:ring-[#4e9815]"
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setFormData({ ...formData, category: e.target.value as RoadmapCategory })}
                          className="w-full px-3 py-2 bg-[#1E1E1E] border border-[#2D2D2D] rounded-md text-[#F2F0ED] focus:outline-none focus:ring-1 focus:ring-[#4e9815]"
                        >
              ...
              <div className="p-6">
                ...
                {isEditing ? (
                  <div className="mb-4">
                    <label className="block text-xs text-[#8C877D] mb-1">Tags (comma separated)</label>
                    <input
                      type="text"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.tags.length > 0 ? (
                        item.tags.map((tag) => (
                          <span key={tag} className="text-xs px-2 py-0.5 rounded-full bg-[#1E1E1E] text-[#8C877D]">
                            {tag}
                          </span>
                        ))
                      ) : (
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-3">
                      {item.comments.map((comment) => (
                        <div key={comment.id} className="p-3 rounded-md bg-[#1E1E1E]">
