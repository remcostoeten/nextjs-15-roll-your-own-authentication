...
export const changelogEntries: ChangelogEntry[] = [
	...
	},
	{
		...
		author: 'remcostoeten',
		githubUrl:
			'https://github.com/remcostoeten/nextjs-15-roll-your-own-authentication/commit/session-expiration-fix',
		votes: 5,
	},
	{
		id: 'cl-004',
		...
		description:
			'Optimized the password hashing algorithm to reduce CPU usage while maintaining security standards.',
		categories: ['performance', 'security'],
		version: '1.1.2',
		author: 'remcostoeten',
		githubUrl:
			'https://github.com/remcostoeten/nextjs-15-roll-your-own-authentication/commit/password-hashing-perf',
		votes: 7,
	},
	{
		id: 'cl-005',
