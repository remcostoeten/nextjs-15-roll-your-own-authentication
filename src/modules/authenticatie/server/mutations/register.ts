...
export async function register(formData: FormData): Promise<RegisterResult> {
	...
	try {
		...
		const AVATAR_OPTIONS = {
			...
			FAT_MAJIN_BUU_2: 'https://c.tenor.com/d9GvSsPKxe8M/majin-buu-buu.gif',
			FAT_MAJIN_BUU_3:
				'https://www.laguiadelvaron.com/wp-content/uploads/2018/03/majin_bu_dog.gif',
			FAT_MAJIN_BUU_4: 'https://c.tenor.com/xHMtksLVNlcC/dbz-gif.gif',
			FAT_MAJIN_BUU_5: 'https://media.tenor.com/z5Y_hp08qAEC/buu-tongue.gif',
			FAT_MAJIN_BUU_6: 'https://c.tenor.com/K3AE3cWEj3QM/eating-buu.gif',
		};
