		...
		<div className="flex flex-col h-full">
			<div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 overflow-auto pb-6 flex-1">
				{statusColumns.map((column) => (
					<div
						key={column.key}
						className="bg-card rounded-lg p-4 shadow min-h-[200px] flex flex-col"
					>
								...
								>
									<CardContent className="p-3">
										<div className="flex items-start gap-2">
											<div
												className={`w-1 self-stretch rounded-full ${getPriorityColor(ticket.priority)}`}
											/>
				...
				<div className="flex justify-center mt-6">
					<Pagination>
						<PaginationContent>
							<PaginationItem>
								<PaginationLink
									href={`/workspace/${workspaceId}/tickets?page=1`}
							...
							{pagination.page > 2 && (
								<PaginationItem>
									<PaginationLink
										href={`/workspace/${workspaceId}/tickets?page=${pagination.page - 1}`}
									>
										{pagination.page - 1}
									</PaginationLink>
								</PaginationItem>
							...
							{pagination.page > 1 && pagination.page < pagination.totalPages && (
								<PaginationItem>
									<PaginationLink
										href={`/workspace/${workspaceId}/tickets?page=${pagination.page}`}
										isActive
									>
										{pagination.page}
									</PaginationLink>
