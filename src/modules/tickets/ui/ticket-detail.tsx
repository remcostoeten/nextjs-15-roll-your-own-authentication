...
import { TicketPriority, TicketStatus, TTicketPriority, TTicketStatus } from "@/api/schemas/ticket-scheme"
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
          ...
          {isEditing ? (
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-2 text-sm text-muted-foreground">
                ...
                <span>•</span>
                <span>Created {formatDistanceToNow(new Date(ticketData.ticket.createdAt), { addSuffix: true })}</span>
                <span>•</span>
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="capitalize">{ticketData.ticket.status.replace("_", " ")}</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Badge className={`capitalize ${getPriorityColor(ticketData.ticket.priority)}`}>
                    ...
                    {ticketData.assignee ? (
                      <div className="flex items-center gap-2">
                        <Avatar className="h-6 w-6">
                          <AvatarImage src={ticketData.assignee.avatar || ""} alt={ticketData.assignee.name || ""} />
                          <AvatarFallback>{ticketData.assignee.name?.charAt(0) || "U"}</AvatarFallback>
                        </Avatar>
            ...
            {isEditing ? (
              ...
              <div className="prose prose-sm max-w-none">
                {ticketData.ticket.description ? (
                  <p className="whitespace-pre-line">{ticketData.ticket.description}</p>
                ) : (
                ...
                {ticketData.history.map(({ history, user }) => (
                  <div key={history.id} className="flex gap-3 text-sm">
                    ...
                    <div>
                      ...
                      {history.field === "status" && (
                        <span>
                          ...
                          <Badge variant="outline" className="capitalize">
                            {history.oldValue?.replace("_", " ") || "none"}
                          </Badge>{" "}
                          to{" "}
                          <Badge variant="outline" className="capitalize">
                            {history.newValue?.replace("_", " ") || "none"}
                          </Badge>
                        </span>
                      )}
                      ...
                      {history.field === "title" && <span>updated the title</span>}
