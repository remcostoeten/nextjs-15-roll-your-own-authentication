    ...
    try {
        ...
        if (existingUser) {
            ...
            try {
                ...
                console.log('[registerUser] Logged failed registration (existing email)');
            } catch (logError) {
                console.error('[registerUser] Failed to log duplicate registration attempt:', logError);
            }
        ...
        try {
            ...
            console.error('[registerUser] Failed to log registration activity:', logError);
            // Continue even if activity logging fails
        }

        // Return user data and tokens
        console.log('[registerUser] Registration successful, returning user data and tokens');
        return {
            user: newUser,
            tokens,
        };
