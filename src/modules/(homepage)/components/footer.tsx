        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="text-[#8C877D] text-sm mb-4">
              Build secure authentication without dependencies or vendor lock-in. Take control of your auth stack with
              pure Next.js 15 implementations.
            </p>
          ...
          <div>
            ...
            <p className="text-[#8C877D] text-sm mb-4">
              Rolling your own auth is a perfect way to increase programming knowledge. If you want to <i>ryoa</i> in
              production make sure to deep dive into advanced database &amp; security topics.
            </p>
