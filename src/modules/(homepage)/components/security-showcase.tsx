      ...
      `}
					...
					>
						...
						<div className="bg-[#0D0C0C] border border-[#1E1E1E] rounded-md p-6 h-full lg:col-span-1">
							...
							<p className="text-[#8C877D] mb-6">
								{independencePrinciples[activeTab].description}
							</p>
					...
					>
						<div className="bg-[#1E1E1E]/30 p-4 border-b border-[#1E1E1E]">
							<h3 className="text-[#F2F0ED] font-semibold">
								Auth Libraries vs. Roll Your Own
							</h3>
						</div>
							...
							<table className="w-full">
								<thead>
									<tr className="border-b border-[#1E1E1E]">
										<th className="p-4 text-left text-[#8C877D]">
											Feature
										</th>
										<th className="p-4 text-left text-[#8C877D]">
											Auth Libraries
								...
								<tbody>
									<tr className="border-b border-[#1E1E1E]">
										<td className="p-4 text-[#F2F0ED]">
											Documentation
										</td>
										<td className="p-4 text-[#8C877D] relative group">
											<span>
												400-page docs that still don't
										...
										<td className="p-4 text-[#8C877D] relative group">
											...
											<div className="absolute left-4 -top-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
												<span className="text-xs bg-[#1E1E1E] border border-[#2D2D2D] rounded px-2 py-1 absolute bottom-full mb-2 w-64 text-[#F2F0ED] shadow-lg z-10">
													...
													"We're sunsetting our
													MongoDB integration. Please
													migrate to our preferred
													solution."
													<div className="absolute top-full left-4 h-2 w-2 rotate-45 bg-[#1E1E1E] border-r border-b border-[#2D2D2D]"></div>
												</span>
											</div>
									...
									<tr className="border-b border-[#1E1E1E]">
										...
										<td className="p-4 text-[#8C877D] relative group">
											<span>
												"We've completely rewritten our
												API again!"
											</span>
											<div className="absolute left-4 -top-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
												<span className="text-xs bg-[#1E1E1E] border border-[#2D2D2D] rounded px-2 py-1 absolute bottom-full mb-2 w-64 text-[#F2F0ED] shadow-lg z-10">
													...
													"Introducing our new v4 API
													with breaking changes to
													everything you've
													implemented!"
													<div className="absolute top-full left-4 h-2 w-2 rotate-45 bg-[#1E1E1E] border-r border-b border-[#2D2D2D]"></div>
												</span>
										...
										<td className="p-4 text-[#8C877D] relative group">
											...
											<div className="absolute left-4 -top-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
												<span className="text-xs bg-[#1E1E1E] border border-[#2D2D2D] rounded px-2 py-1 absolute bottom-full mb-2 w-64 text-[#F2F0ED] shadow-lg z-10">
													...
													"Free tier? Yes! Until you
													hit 50k users, then
													$0.06/user/month. Surprise!"
													<div className="absolute top-full left-4 h-2 w-2 rotate-45 bg-[#1E1E1E] border-r border-b border-[#2D2D2D]"></div>
												</span>
											</div>
										</td>
