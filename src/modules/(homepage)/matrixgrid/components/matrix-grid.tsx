    ...
    <MatrixGridLayout>
      ...
      >
        <div className={styles.wrapper}>
          <motion.div className={styles.header} variants={itemVariants} ref={headerRef} style={{ borderTop: "none" }}>
            <div className={styles.stickyContainer}>
              ...
              <div className="mt-8 border-t border-l border-[#1E1E1E] p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#8C877D] text-sm font-mono border-l-2 border-[#1E1E1E] pl-3">{headerSubtitle}</p>
          ...
          <AnimatePresence>
            {mounted && (
              <motion.div className={styles.grid} variants={containerVariants} ref={gridRef}>
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <motion.div className={styles.cardDescription}>{tool.description}</motion.div>
                      </div>
                      {!tool.isLarge && (
                    ...
                    {tool.isLarge && (
                      <>
                        <motion.div className={styles.skeletonLoader} aria-hidden="true" variants={itemVariants} />
                        <motion.div className={styles.platformGradient} variants={itemVariants} />
                        <motion.div className={styles.platformSideGradient} variants={itemVariants} />
                      </>
                    )}
                    <motion.div className={styles.horizontalBorder} variants={itemVariants} />
                  </MotionLink>
                ))}
              </motion.div>
            )}
