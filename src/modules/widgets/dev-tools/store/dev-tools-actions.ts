...
import type { DevToolsState, Position, WidgetSize, Theme } from '@/shared/types/widget-types'
...
export function createDevToolsActions(set: (fn: (state: DevToolsState) => Partial<DevToolsState>) => void) {
	return {
