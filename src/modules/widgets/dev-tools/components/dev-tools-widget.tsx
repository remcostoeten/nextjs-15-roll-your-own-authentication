...
export function DevToolsWidget({
	...
	// Update the safe position values
	const safePosition = {
		x: typeof position?.x === 'number' ? position.x : 20, // 20px from left
		y: typeof position?.y === 'number' ? position.y : 20, // 20px from top
	}
	...
	}, [dragPosition, widgetSize, setPosition])
	...
	return (
		<div className={themeClass}>
			...
			{/* View All Dialog */}
			<Dialog
				open={viewAllData !== null}
				onOpenChange={handleCloseViewAll}
			>
