...
const fallbackCommit: CommitData = {
	...
	html_url:
		'https://github.com/remcostoeten/nextjs-15-roll-your-own-authentication/commit/jwt-implementation',
	commit: {
		message:
			'feat(auth): Implement JWT authentication with zero dependencies',
		author: {
			name: 'remcostoeten',
