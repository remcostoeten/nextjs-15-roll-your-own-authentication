  ...
  return (
    <div className="ml-2 flex gap-1">
      {commits?.slice(0, 5).map((commit, index) => (
        <CommitSquare key={commit.sha} commit={commit} index={index} />
      ))}
    </div>
  );
}
...
export default function GitHubRepository() {
  const [repository, setRepository] = useState<IGitHubRepository | null>(
    null,
  );
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        setLoading(false);
        toast.error('Failed to load repository data. Please try again later.');
      }
    }
  ...
  if (error) {
    return (
      <div className="container -auto max-w-4xl px-4 py-6">
  ...
  return (
    ...
    >
      ...
      {/* Command line with project metrics */}
      <motion.div
      ...
      >
        <div className="flex items-center">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-[#8C877D]">Default branch:</span>
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-[#8C877D]">Main language:</span>
                    <span className="text-[#F2F0ED]">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-[#8C877D]">Last updated:</span>
                    <span className="text-[#F2F0ED]">
                      {repository?.updated_at
                        ? getRelativeTime(repository.updated_at)
                        : 'Unknown'}
                    </span>
                  </div>
                  ...
                  <div className="mt-2 flex gap-4 border-t border-[#1E1E1E] pt-2">
                    ...
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <span className="text-[#F2F0ED]">
                        {repository?.watchers_count || 0} watchers
                      </span>
                    </div>
                  </div>
                </div>
          ...
          <div className="flex items-center">
            <span className="text-[#F2F0ED]">
              {repository?.name || 'nextjs-15-roll-your-own-authentication'}
            </span>

            {/* Small commit squares next to repo name with Suspense for loading state */}
            <Suspense fallback={<CommitSquaresSkeleton />}>
              {commits ? <CommitSquares commits={commits} /> : <CommitSquaresSkeleton />}
            </Suspense>
          </div>
        </div>
      </motion.div>
      ...
      >
        {loading ? (
          ...
          <div className="flex items-center">
            <span className="mr-2 font-mono">$</span>
            <span className="text-red-400">Error fetching commit</span>
          </div>
        ) : (
          latestCommit && (
            <>
              ...
              <button
                ref={commitLinkRef}
                className="group relative font-mono text-[#4e9815] transition-colors duration-200 hover:text-[#6bc427] hover:underline"
              ...
              {showTooltip && (
                ...
                >
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="pt-1">
                      <div className="mb-1 text-[#8C877D]">Message</div>
