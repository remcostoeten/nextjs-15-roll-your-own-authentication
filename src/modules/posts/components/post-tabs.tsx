...
export function PostTabs({ activeTab, onChange }: PostTabsProps) {
    const tabs = [
        { id: "following" as const, label: "Following", icon: <Heart className="h-4 w-4" /> },
        { id: "featured" as const, label: "Featured", icon: <Award className="h-4 w-4" /> },
        { id: "rising" as const, label: "Rising", icon: <Zap className="h-4 w-4" /> },
    ]
