...
export function HeadingShowcase() {
    return (
        <div className="border border-button-border rounded-lg p-6 bg-background-lighter">
            <Heading level="h3" hasMargin={true}>
                Heading Components
            </Heading>
            <Flex direction="col" gap={4}>
                {[1, 2, 3, 4, 5, 6].map((level) => (
                    ...
                    >
                        <Heading level={`h${level}` as any} hasMargin={false}>
                            Heading {level}
                        </Heading>
                        <Text variant="muted">
...
export function TextVariantsShowcase() {
    const variants = [
        ...
        { name: 'large', description: 'Used for highlighting important information' },
            ...
            <Flex direction="col" gap={4}>
                {variants.map((variant, index) => (
                    <Flex
                        ...
                        gap={1}
                        className={`pb-4 ${
                            index !== variants.length - 1 ? 'border-b border-button-border' : ''
                        }`}
                    >
        ...
        <div className="border border-button-border rounded-lg p-6 bg-background-lighter">
            ...
            <Flex direction="col" gap={4}>
                <Flex direction="col" gap={1} className="pb-4 border-b border-button-border">
                    <Heading level="h4" hasLink linkHref="#" hasMargin={false}>
                        Linked Heading
                    </Heading>
        ...
        <div className="border border-button-border rounded-lg p-6 bg-background-lighter">
            ...
            <Flex direction="col" gap={6}>
                <Flex direction="col" gap={2}>
                    <Heading level="h4" hasMargin={false}>
                        Row Layout (Default)
                    </Heading>
                    <Flex items="center" justify="between" className="bg-background p-4 rounded border border-button-border">
                        {[1, 2, 3].map((num) => (
                            <div key={num} className="h-16 w-16 bg-button flex items-center justify-center border border-button-border rounded">
                                Item {num}
                            </div>
                        ))}
                    </Flex>
                ...
                <Flex direction="col" gap={2}>
                    ...
                    <Flex direction="col" gap={2} className="bg-background p-4 rounded border border-button-border">
                        {[1, 2, 3].map((num) => (
                            <div key={num} className="h-12 bg-button flex items-center justify-center border border-button-border rounded">
                                Item {num}
                            </div>
                        ))}
                    </Flex>
        ...
        <div className="border border-button-border rounded-lg p-6 bg-background-lighter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-background-lighter border border-button-border rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                        <Heading level="h4" hasMargin={true}>
                            Card Title
                        </Heading>
                ...
                <div className="border border-button-border rounded-lg overflow-hidden">
                    <Flex items="center" justify="between" className="p-4 bg-background-lighter">
                        ...
                        <Flex items="center" gap={4}>
                            <Link href="#" className="text-button hover:text-title-light">
                                Home
                            </Link>
                            <Link href="#" className="text-button hover:text-title-light">
                                About
                ...
                <div className="border border-button-border rounded-lg overflow-hidden">
                    <Tabs defaultValue="tab1" className="w-full">
                        <TabsList className="bg-button border border-button-border w-full">
                            <TabsTrigger value="tab1" className="flex-1 data-[state=active]:bg-background-lighter data-[state=active]:text-title-light text-button">
                                Tab 1
                            </TabsTrigger>
                            <TabsTrigger value="tab2" className="flex-1 data-[state=active]:bg-background-lighter data-[state=active]:text-title-light text-button">
                                Tab 2
                            </TabsTrigger>
                            <TabsTrigger value="tab3" className="flex-1 data-[state=active]:bg-background-lighter data-[state=active]:text-title-light text-button">
                                Tab 3
                            </TabsTrigger>
                        </TabsList>
