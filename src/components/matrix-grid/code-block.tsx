		...
		content: [
			{
				type: 'comment',
				content:
					'// auth-utils.ts - Copy and paste this file into your project',
			},
		],
	},
	{
		...
		content: [
			{
				type: 'comment',
				content:
					'// Hash a password with PBKDF2 - no dependencies needed',
			},
		],
	},
	{
...
const USER_LOGIN_CODE = [
		...
		content: [
			{
				type: 'comment',
				content:
					'// auth.ts - Copy and paste this file into your project',
			},
		],
	},
	{
	...
	},
	{
		...
		content: [
			{
				type: 'comment',
				content: '// Define your user type - customize as needed',
			},
		],
	},
	{
		...
		content: [
			{
				type: 'comment',
				content:
					'// Server action for user login - use in your route handlers',
			},
		],
	},
	{
	...
	},
	{
		...
		content: [
			{
				type: 'comment',
				content: '    // In a real app, fetch user from your database',
			},
		],
	},
	{
	...
	},
	{
		...
		content: [
			{
				type: 'comment',
				content: '    // Verify password using our utility',
			},
		],
	},
	{
	...
	},
	{
		lineNumber: 31,
		content: [
			{ type: 'comment', content: '    // Create a session token' },
		],
	},
	{
		lineNumber: 32,
	...
	},
	{
		...
		content: [
			{
				type: 'comment',
				content: '    // Store session in your database',
			},
		],
	},
	{
		...
		content: [
			{
				type: 'comment',
				content:
					'    // Set the cookie - Next.js built-in, no dependencies',
			},
		],
	},
	{
		...
		content: [
			{
				type: 'comment',
				content:
					'// Helper functions to implement with your database of choice',
			},
		],
	},
	{
...
const getRawCode = (activeTab: string) => {
	const codeExample =
		activeTab === 'createUser.ts' ? USER_CREATION_CODE : USER_LOGIN_CODE
	return codeExample
		.map((line) => line.content.map((token) => token.content).join(''))
		.join('\n')
}
