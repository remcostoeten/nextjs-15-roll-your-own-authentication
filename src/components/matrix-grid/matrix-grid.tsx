                ...
                {matrixGridContent.tools.map((tool, index) => (
                  ...
                  >
                    ...
                    {hoveredCardIndex === index && (
                      <MatrixSpotlight mouseX={mousePosition.x} mouseY={mousePosition.y} />
                    )}
                    <div
                    ...
                    >
                      <div>
                        ...
                        <motion.div className={styles.cardDescription} variants={textVariants}>
                          {tool.description.split(" ").slice(0, 15).join(" ")}
                          {tool.description.split(" ").length > 15 ? "..." : ""}
                        </motion.div>
                      </div>
                      {!tool.isLarge && (
                        <motion.div variants={textVariants} className={styles.arrowContainer}>
                          <Arrow />
                        </motion.div>
                      )}
                    </motion.div>
