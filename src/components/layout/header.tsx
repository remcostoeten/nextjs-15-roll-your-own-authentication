  ...
  return (
    ...
    >
      ...
      <div className="flex h-16 items-center justify-between px-6">
        ...
        >
          {navItems.map((item) => (
            <motion.div key={item.name} variants={itemVariants} className="flex items-center justify-center">
              {item.isDropdown ? (
                      ...
                      {item.items?.map((subItem) => (
                        <DropdownMenuItem key={subItem.name} asChild>
                          ...
                          >
                            ...
                            {subItem.description && (
                              <span className="text-xs text-[#8C877D]">{subItem.description}</span>
                            )}
                          </Link>
                        </DropdownMenuItem>
                      ))}
                ...
                <TextScrambler href={item.href} text={item.name} isActive={pathname === item.href} />
              )}
            </motion.div>
          ))}
