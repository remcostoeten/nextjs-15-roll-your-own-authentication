	...
	const getCellStyle = (index: number) => {
		...
		return {
			...
			backgroundColor: isHovered
				? config.cellHoverColor
				: config.cellBackgroundColor,
			transition: `${baseTransition}, transform 600ms cubic-bezier(0.4, 0, 0.2, 1)`,
			transform: isHovered
				? 'scale(1.1)'
				: wasPreviouslyHovered
					? 'scale(0.95)'
					: 'scale(1)',
				...
				<div className="flex items-center justify-between mb-8">
					<div>
						...
						<p className="text-white/60 mt-2">
							Customize the interactive background grid with
							various parameters
						</p>
					</div>
					...
					<Tabs defaultValue="layout" className="w-full">
							...
							<div className="grid grid-cols-2 gap-4">
								...
								<div className="space-y-2">
									...
									<Slider
										...
										onValueChange={([value]) =>
											updateConfig('hoverRotation', value)
										}
									/>
								</div>
								<div className="space-y-2">
								...
								<div className="space-y-2">
									...
									<Slider
										...
										onValueChange={([value]) =>
											updateConfig('trailOpacity', value)
										}
									/>
								</div>
						...
						<TabsContent value="code" className="space-y-4">
							...
							<p className="text-sm text-white/60">
								Copy this code to use the BackgroundGrid
								component in your project. Make sure to import
								the component and required styles.
							</p>
						</TabsContent>
					</Tabs>
				</div>
