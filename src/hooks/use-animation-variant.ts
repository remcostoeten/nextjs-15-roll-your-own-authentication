...
import { AnimationVariant } from "../types/shield"
...
export function useAnimationVariant(variant: AnimationVariant = 'trace') {
    ...
    // Define all variants
    const allVariants: Record<AnimationVariant, {
        ...
        "glitch": {
            ...
            pathVariants: basePathVariants,
            segmentVariants: baseSegmentVariants,
            className: "relative before:absolute before:inset-0 before:bg-current before:opacity-50 before:mix-blend-multiply before:animate-glitch"
        },
        "liquid": {
            containerVariants: {
                hidden: { opacity: 0 },
