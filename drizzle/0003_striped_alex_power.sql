...
--> statement-breakpoint
ALTER TABLE "ticket_history" DROP CONSTRAINT "ticket_history_user_id_users_id_fk";
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "workspace_activities" DROP CONSTRAINT "workspace_activities_target_user_id_users_id_fk";
--> statement-breakpoint
