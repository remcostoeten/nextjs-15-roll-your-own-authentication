    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {metrics.realtimeVisitors > 0 && (
            <Badge variant="outline" className="bg-green-50 text-green-700 border
            green-200">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="pages">
          <AnalyticsPages projectId={projectId} filter={filter} />
        </TabsContent>
        <TabsContent value="geo">
          <AnalyticsGeo projectId={projectId} filter={filter} />
        </TabsContent>
        <TabsContent value="events">
          <AnalyticsEvents projectId={projectId} filter={filter} />
        </TabsContent>
        <TabsContent value="realtime">
          <AnalyticsRealtime projectId={projectId} />
        </TabsContent>
      </Tabs>
    </div>
  )
